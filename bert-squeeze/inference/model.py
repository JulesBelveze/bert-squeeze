...
class ModelWrapper:
    def __init__(self, checkpoint_path: str, preprocessor, postprocessor=None, *args, **kwargs):
    ...
    @staticmethod
    def _get_ort_session(checkpoint_path: str, opt_level: int = 99, use_gpu: bool = True,
                         parallelize: bool = True, n_threads: int = 4, **kwargs):
